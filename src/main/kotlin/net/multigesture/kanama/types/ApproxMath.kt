 ...
 * `isEqualApprox`/`isZeroApprox` helpers match the engine without a per-component engine round-trip.
 * `CMP_EPSILON` is Godot's `0.00001` (`core/math/math_defs.h`), the same for single and double.
 *
