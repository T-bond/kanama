...
class RichTextLabel(handle: MemorySegment) : Control(handle) {
     ...
     */
    fun addImage(image: Texture2D?, width: Int = 0, height: Int = 0, color: Color, inlineAlign: Long = 5L, region: Rect2, key: Any? = null, pad: Boolean = false, tooltip: String = "", widthInPercent: Boolean = false, heightInPercent: Boolean = false, altText: String = "") {
        ObjectCalls.ptrcallWithObjectTwoIntColorLongRect2VariantBoolStringTwoBoolStringArgs(addImageBind, handle, image?.requireOpenHandle() ?: MemorySegment.NULL, width, height, color, inlineAlign, region, key, pad, tooltip, widthInPercent, heightInPercent, altText)
    }
     ...
     */
    fun updateImage(key: Any?, mask: Long, image: Texture2D?, width: Int = 0, height: Int = 0, color: Color, inlineAlign: Long = 5L, region: Rect2, pad: Boolean = false, tooltip: String = "", widthInPercent: Boolean = false, heightInPercent: Boolean = false) {
        ObjectCalls.ptrcallWithVariantLongObjectTwoIntColorLongRect2BoolStringTwoBoolArgs(updateImageBind, handle, key, mask, image?.requireOpenHandle() ?: MemorySegment.NULL, width, height, color, inlineAlign, region, pad, tooltip, widthInPercent, heightInPercent)
    }
