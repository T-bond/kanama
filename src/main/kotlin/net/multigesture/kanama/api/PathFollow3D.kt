...
class PathFollow3D(handle: MemorySegment) : Node3D(handle) {
    ...
    fun getProgress(): Double =
        ObjectCalls.ptrcallNoArgsRetDouble(getProgressBind, handle)
    ...
    fun getHOffset(): Double =
        ObjectCalls.ptrcallNoArgsRetDouble(getHOffsetBind, handle)
    ...
    fun getVOffset(): Double =
        ObjectCalls.ptrcallNoArgsRetDouble(getVOffsetBind, handle)
    ...
    fun getProgressRatio(): Double =
        ObjectCalls.ptrcallNoArgsRetDouble(getProgressRatioBind, handle)
    ...
    fun getRotationMode(): Long =
        ObjectCalls.ptrcallNoArgsRetLong(getRotationModeBind, handle)
    ...
    fun getCubicInterpolation(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(getCubicInterpolationBind, handle)
    ...
    fun isUsingModelFront(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(isUsingModelFrontBind, handle)
     ...
     */
    fun hasLoop(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(hasLoopBind, handle)
    ...
    fun isTiltEnabled(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(isTiltEnabledBind, handle)
    ...
    fun correctPosture(transform: Transform3D, rotationMode: Long): Transform3D =
        ObjectCalls.ptrcallWithTransform3DAndLongArgsRetTransform3D(
            correctPostureBind,
            handle,
            transform,
            rotationMode,
