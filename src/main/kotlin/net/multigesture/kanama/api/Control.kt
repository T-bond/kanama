...
open class Control(handle: MemorySegment) : CanvasItem(handle) {
     ...
     */
    fun getCursorShape(position: Vector2): Long {
        return ObjectCalls.ptrcallWithVector2ArgRetLong(getCursorShapeBind, handle, position)
    }
    ...
    companion object {
        ...
        private const val SET_ACCESSIBILITY_LIVE_HASH = 1720261470L
        ...
        private const val GET_ACCESSIBILITY_LIVE_HASH = 3311037003L
