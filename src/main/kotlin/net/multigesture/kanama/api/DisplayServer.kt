...
object DisplayServer {
     ...
     */
    @JvmStatic
    fun accessibilityUpdateSetBounds(id: RID, pRect: Rect2) {
        ObjectCalls.ptrcallWithRIDAndRect2Arg(accessibilityUpdateSetBoundsBind, singleton, id, pRect)
    }
     ...
     */
    @JvmStatic
    fun cursorSetCustomImage(cursor: Resource?, shape: Long = 0L, hotspot: Vector2) {
