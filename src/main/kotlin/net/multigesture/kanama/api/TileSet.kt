...
class TileSet(handle: MemorySegment) : Resource(handle) {
     ...
     */
    fun setCoordsLevelTileProxy(pSourceFrom: Int, coordsFrom: Vector2i, sourceTo: Int, coordsTo: Vector2i) {
        ObjectCalls.ptrcallWithIntVector2iIntVector2iArgs(setCoordsLevelTileProxyBind, handle, pSourceFrom, coordsFrom, sourceTo, coordsTo)
    }
