...
class RayCast3D(handle: MemorySegment) : Node3D(handle) {
    ...
    fun getCollider(): GodotObject? =
        GodotObject.wrap(ObjectCalls.ptrcallNoArgsRetObject(getColliderBind, handle))
    ...
    fun getColliderRid(): RID =
        ObjectCalls.ptrcallNoArgsRetRID(getColliderRidBind, handle)
    ...
    fun getColliderShape(): Int =
        ObjectCalls.ptrcallNoArgsRetInt(getColliderShapeBind, handle)
    ...
    fun getCollisionPoint(): Vector3 =
        ObjectCalls.ptrcallNoArgsRetVector3(getCollisionPointBind, handle)
    ...
    fun getCollisionNormal(): Vector3 =
        ObjectCalls.ptrcallNoArgsRetVector3(getCollisionNormalBind, handle)
    ...
    fun getCollisionFaceIndex(): Int =
        ObjectCalls.ptrcallNoArgsRetInt(getCollisionFaceIndexBind, handle)
    ...
    fun isHitFromInsideEnabled(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(isHitFromInsideEnabledBind, handle)
    ...
    fun isHitBackFacesEnabled(): Boolean =
        ObjectCalls.ptrcallNoArgsRetBool(isHitBackFacesEnabledBind, handle)
    ...
    fun getDebugShapeThickness(): Int =
        ObjectCalls.ptrcallNoArgsRetInt(getDebugShapeThicknessBind, handle)
    ...
    companion object {
        ...
        private val isCollideWithAreasEnabledBind by lazy {
            ObjectCalls.getMethodBind(
                ...
                IS_COLLIDE_WITH_AREAS_ENABLED_HASH,
            )
        }
        ...
        private val isCollideWithBodiesEnabledBind by lazy {
            ObjectCalls.getMethodBind(
                ...
                IS_COLLIDE_WITH_BODIES_ENABLED_HASH,
            )
        }
        ...
        private val setDebugShapeCustomColorBind by lazy {
            ObjectCalls.getMethodBind(
                ...
                SET_DEBUG_SHAPE_CUSTOM_COLOR_HASH,
            )
        }
        ...
        private val getDebugShapeCustomColorBind by lazy {
            ObjectCalls.getMethodBind(
                ...
                GET_DEBUG_SHAPE_CUSTOM_COLOR_HASH,
            )
        }
