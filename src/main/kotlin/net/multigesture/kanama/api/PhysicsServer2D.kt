...
object PhysicsServer2D {
     ...
     */
    @JvmStatic
    fun bodySetShapeAsOneWayCollision(body: RID, shapeIdx: Int, enable: Boolean, margin: Double) {
        ObjectCalls.ptrcallWithRIDIntBoolDoubleArgs(bodySetShapeAsOneWayCollisionBind, singleton, body, shapeIdx, enable, margin)
    }
     ...
     */
    @JvmStatic
    fun bodyApplyImpulse(body: RID, impulse: Vector2, position: Vector2) {
     ...
     */
    @JvmStatic
    fun bodyApplyForce(body: RID, force: Vector2, position: Vector2) {
     ...
     */
    @JvmStatic
    fun bodyAddConstantForce(body: RID, force: Vector2, position: Vector2) {
    ...
    private const val BODY_SET_SHAPE_AS_ONE_WAY_COLLISION_HASH = 2556489974L
