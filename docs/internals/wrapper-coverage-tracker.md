...
| 5.3 iOS implementation (+ callV return marshalling) | opus | todo | after 5.2; same model, extend `IosScriptCodeEmitter` past the fixed lifecycle `when` + add `callV` return marshalling; device-check |
