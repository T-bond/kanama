...
the Godot 4.7 beta 4 preview baseline. It proves that Kanama can run inside a
...
Eight public demo exports are Android smoke targets. The beta 4 Android matrix
...
`ANDROID_SDK_ROOT`, and `JAVA_HOME`. The 4.7 beta 4 Android export-template
