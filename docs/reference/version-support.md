...
(2026-07-13); Linux x86_64 re-passed the full local CI, demo, TPS, package, and
native-artifact gates against Godot 4.7 stable on 2026-07-13/14. Linux arm64
remains pending 4.7-stable revalidation.
