...
| Source-first install before packaged releases | The `0.1.0` preview still uses the source checkout as the main install/update path; packaged addon artifacts are separate release work. |
