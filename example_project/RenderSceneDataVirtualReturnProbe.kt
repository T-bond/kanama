...
/**
 * Task 29 probe: exercises the Projection virtual-return family against
 * RenderSceneDataExtension's virtual table.
 */
...
class RenderSceneDataVirtualReturnProbe(val godotObject: MemorySegment) {
    ...
    @OverrideVirtual
    fun _get_cam_projection(): Projection = Projection(
