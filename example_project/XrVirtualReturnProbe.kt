...
/**
 * Task 29 probe: exercises the Transform3D, PackedVector3Array
 * (`List<Vector3>`), and PackedFloat64Array (`DoubleArray`) virtual-return
 * families against XRInterfaceExtension's virtual table.
 */
...
class XrVirtualReturnProbe(val godotObject: MemorySegment) {
    ...
    @OverrideVirtual
    fun _get_projection_for_view(view: Long, aspect: Double, zNear: Double, zFar: Double): DoubleArray =
        doubleArrayOf(aspect, zNear, zFar, 1.0e308)
}
