...
/**
 * Task 29 probe: exercises the PackedByteArray (`ByteArray`) and
 * PackedInt32Array (`IntArray`) virtual-return families against
 * TextServerExtension's virtual table. Width-sensitive values: full-range
 * bytes and Int.MAX_VALUE catch element-width regressions.
 */
...
class TextServerVirtualReturnProbe(val godotObject: MemorySegment) {
    ...
    @OverrideVirtual
    fun _get_support_data(): ByteArray = byteArrayOf(0x7F, 0x00, -0x80)
